export default {
  ...
  colors: {
    ...
    heading: "#00D3BA", // primary heading color
    heading_secondary: "#FFFFFF", // heading color
    background: "#171921", // body background color
    background_secondary: "#1D1F29", // secondary background color
    border_color: "#00D3BA", // border color
  ...
  buttons: {
    ...
    imgButton: {
      ...
      boxShadow:  '10px -10px 10px #16171f, -10px 10px 10px #242733',
      color: "white",
      "&:hover": {
        border: "solid muted",
        borderColor: "muted",
